...
import com.textengine.ui.view.TextEngineOverviewController;
...
//        parser.parse(documentUrl);
        ...
        this.primaryStage.setTitle("Text Sentic Engine by Somz (using Senticnet4 dictionary)");
